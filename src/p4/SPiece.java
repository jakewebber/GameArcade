		...
		if(direction == 'c') {
			...
			if(numTurns % 2 == 0) {
				try {
					...
					&& (super.currentPanelValues[blocksToMove[1][0]    ][blocksToMove[1][1] + 1] == '\u0000'
					...
					|| super.currentPanelValues[blocksToMove[3][0]    ][blocksToMove[3][1] - 1] == 'X')) {
						...
						super.currentPanelValues[blocksToMove[2][0] + 1][blocksToMove[3][1] - 1] = 'X';
						super.currentPanelValues[blocksToMove[2][0]][blocksToMove[3][1]] = '\u0000';
						super.currentPanelValues[blocksToMove[3][0]    ][blocksToMove[3][1] - 1] = 'X';
				...
				try {
					if((super.currentPanelValues[blocksToMove[1][0] + 2][blocksToMove[1][1] - 1] == '\u0000'
					|| super.currentPanelValues[blocksToMove[1][0] + 2][blocksToMove[1][1] - 1] == 'X')
					&& (super.currentPanelValues[blocksToMove[2][0]    ][blocksToMove[3][1] - 1] == '\u0000'
					|| super.currentPanelValues[blocksToMove[2][0]    ][blocksToMove[3][1] - 1] == 'X')) {
